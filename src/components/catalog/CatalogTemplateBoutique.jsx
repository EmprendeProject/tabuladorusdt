      ...
      <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto shadow-2xl bg-[#fdfcfb]">
        <header className="sticky top-0 z-50 flex items-center bg-[#fdfcfb]/90 backdrop-blur-md p-4 pb-2 justify-between border-b border-gray-100">
          <button
            type="button"
            onClick={onReload}
            className="text-[#111318] flex size-12 shrink-0 items-center justify-start"
            title="Actualizar"
        ...
        <nav className="pb-1 bg-[#fdfcfb]">
          <div className="flex border-b border-[#dcdee5] px-4 gap-8 overflow-x-auto">
            <Tab active>New Arrivals</Tab>
            <Tab>Collections</Tab>
            <Tab>Accessories</Tab>
            <Tab>Essentials</Tab>
          </div>
        ...
        <main className="flex flex-col gap-6 py-5">
          <div className="px-4">
            ...
            />
            <div className="mt-2 flex items-center justify-between text-xs text-[#636c88]">
              <span>
              ...
              <button
                ...
                onClick={onReload}
                disabled={cargando}
                className="text-[#1745cf] font-bold uppercase tracking-[0.2em] disabled:opacity-50"
              >
                  ...
                  <div className="flex w-full flex-col items-start justify-center gap-2 py-5 px-1">
                    <div className="flex justify-between w-full items-baseline gap-4">
                      ...
                      <p className="text-[#111318] text-lg italic font-[Newsreader,serif] shrink-0">
                        ${formatearNumero(p.precioUSDT, 2)}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <footer className="sticky bottom-0 z-50 flex border-t border-gray-100 bg-[#fdfcfb]/95 backdrop-blur-lg px-8 py-3 justify-between items-center">
          <div className="flex flex-col items-center gap-1 text-[#1745cf]">
            <div className="h-6 w-6 rounded-full bg-[#1745cf]/10" />
            <span className="text-[10px] uppercase font-bold tracking-tighter">Catalog</span>
          </div>
          <div className="flex flex-col items-center gap-1 text-gray-400">
            <div className="h-6 w-6 rounded-full bg-gray-200/50" />
            <span className="text-[10px] uppercase font-bold tracking-tighter">Saved</span>
          </div>
          <div className="flex flex-col items-center gap-1 text-gray-400">
            <div className="h-6 w-6 rounded-full bg-gray-200/50" />
